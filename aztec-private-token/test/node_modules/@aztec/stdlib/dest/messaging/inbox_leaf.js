...
export class InboxLeaf {
    ...
    static smallestIndexFromL2Block(l2blockNumber) {
   ...
   */ static indexRangeFromL2Block(l2blockNumber) {
    ...
    /** Returns the L2 block number for a given leaf index */ static l2BlockFromIndex(index) {

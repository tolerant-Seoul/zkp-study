 ...
 */ export class TxExecutionRequest {
   ...
   * @returns The buffer.
   */ toBuffer() {
        return serializeToBuffer(this.origin, this.functionSelector, this.firstCallArgsHash, this.txContext, new Vector(this.argsOfCalls), new Vector(this.authWitnesses), new Vector(this.capsules), this.salt);
    }
    /**
   ...
   */ static fromBuffer(buffer) {
        ...
        return new TxExecutionRequest(reader.readObject(AztecAddress), reader.readObject(FunctionSelector), Fr.fromBuffer(reader), reader.readObject(TxContext), reader.readVector(HashedValues), reader.readVector(AuthWitness), reader.readVector(Capsule), Fr.fromBuffer(reader));
    }
    /**

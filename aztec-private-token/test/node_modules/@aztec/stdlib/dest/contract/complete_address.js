 ...
 */ export class CompleteAddress {
    ...
    publicKeys;
    partialAddress;
    constructor(/** Contract address (typically of an account contract) */ address, /** User public keys */ publicKeys, /** Partial key corresponding to the public key to the address. */ partialAddress){
        this.address = address;
        this.publicKeys = publicKeys;
        this.partialAddress = partialAddress;
    }
    static async create(address, publicKeys, partialAddress) {
        const completeAddress = new CompleteAddress(address, publicKeys, partialAddress);
        await completeAddress.validate();
        return completeAddress;
    }
    /** Size in bytes of an instance */ static SIZE_IN_BYTES = 32 * 10;
    static get schema() {
    ...
    /** Throws if the address is not correctly derived from the public key and partial address.*/ async validate() {
   ...
   */ equals(other) {
        return this.address.equals(other.address) && this.publicKeys.equals(other.publicKeys) && this.partialAddress.equals(other.partialAddress);
    }
    /**

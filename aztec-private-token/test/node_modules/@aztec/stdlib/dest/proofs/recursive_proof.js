 ...
 */ export class RecursiveProof {
   ...
   */ static fromBuffer(buffer, expectedSize) {
        ...
        return new RecursiveProof(reader.readArray(size, Fr), Proof.fromBuffer(reader), reader.readBoolean(), size);
    }
    /**
 ...
 */ export function makeEmptyRecursiveProof(size) {
    return new RecursiveProof(makeTuple(size, Fr.zero), makeEmptyProof(), true, size);
}
export function makeRecursiveProof(size, seed = 1) {
    return new RecursiveProof(makeTuple(size, (i)=>new Fr(i), seed), makeEmptyProof(), true, size);
}
/**
 ...
 */ export function makeRecursiveProofFromBinary(proof, size) {
    return new RecursiveProof(makeTuple(size, Fr.zero), proof, false, size);
}

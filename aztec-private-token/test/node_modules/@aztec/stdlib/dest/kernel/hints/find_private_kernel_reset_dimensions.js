...
export function findPrivateKernelResetDimensions(requestedDimensions, config, isInner = false, allowRemainder = false) {
    ...
    const isQualified = !isInner ? isEnough : (dimensions)=>dimensions.NOTE_HASH_SILOING === 0 && dimensions.NULLIFIER_SILOING === 0 && dimensions.PRIVATE_LOG_SILOING === 0 && isEnough(dimensions);
    const options = [

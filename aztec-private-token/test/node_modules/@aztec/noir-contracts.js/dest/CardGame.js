...
import CardGameContractArtifactJson from '../artifacts/card_game_contract-CardGame.json' with {
    type: 'json'
};
 ...
 */ export class CardGameContract extends ContractBase {
   ...
   */ static get artifactForPublic() {
        return loadContractArtifactForPublic(CardGameContractArtifactJson);
    }
    static get storage() {
        return {
            collections: {

...
export declare class PrivateTokenContract extends ContractBase {
     ...
     */
    static deploy(wallet: Wallet, initial_supply: (bigint | number), owner: AztecAddressLike): DeployMethod<PrivateTokenContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, initial_supply: (bigint | number), owner: AztecAddressLike): DeployMethod<PrivateTokenContract>;
    /**
